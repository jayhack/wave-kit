...
export default function EditablePlayground() {
  return (
    <main className="min-h-screen bg-wave-canvas px-6 py-16 text-wave-body sm:px-10 lg:px-16">
      <div className="mx-auto max-w-3xl">
        <TextLink href="/">← Back to Wave Kit</TextLink>
        <div className="mt-20 space-y-8">
          <EditableTitle
            className="text-4xl font-semibold tracking-[-0.04em] text-wave-heading sm:text-6xl"
          ...
          <EditableText
            className="max-w-2xl text-lg leading-8 text-wave-muted sm:text-xl sm:leading-9"
